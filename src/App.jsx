  ...
  return (
    <div className="min-h-screen bg-zinc-900 p-6">
      ...
      <div className="min-h-screen md:border md:rounded-md md:border-zinc-700 md:p-9">
        ...
        =========================================================
        */}
        <div className={`${isSticky ? "fixed w-screen max-w-full right-0 px-10 top-0 z-50" : "relative md:w-full md:max-w-6xl"}  hidden sm:flex justify-between bg-zinc-900 text-gray-200 md:text-base sm:text-sm text-base border-t border-b border-zinc-700 py-3 px-2 `}>
